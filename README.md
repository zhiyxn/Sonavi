...
`.github/workflows/ci.yml` 为 Windows x64、macOS Intel x64 与 macOS Apple Silicon arm64 建立独立检查/打包 job，不上传产物。P06 提交 `a831be6` 的 run `34810276941` 三个目标全部成功；P07 当前 Windows x64 主机已通过生产构建、Electron 冒烟和目录包冒烟，尚未提交进入三目标 CI。
