# Sonavi 0.1.0-rc.1 测试版

这是 Sonavi 首个跨平台候选测试版，供 Windows 11 x64、macOS 13+ Intel x64 和 macOS 13+ Apple Silicon arm64 用户试用。

## 下载

- Windows x64：`Sonavi-0.1.0-rc.1-win-x64.exe`
- macOS Intel x64：`Sonavi-0.1.0-rc.1-mac-x64.dmg`
- macOS Apple Silicon arm64：`Sonavi-0.1.0-rc.1-mac-arm64.dmg`
