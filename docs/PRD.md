...
状态：P01～P10 已按序实现到当前发布前代码闸门；`v0.1.0-rc.3`（构建自 `cc33168`，不含 P11 修复）已在 release run `35040657787` 三目标全通过并发布为 GitHub Pre-release，P11 审查修复提交 `557b62d` 之后版本推进到 `0.1.0-rc.4`，候选标签待发布，正式签名/公证/实机发布验收未完成
更新日期：2026-09-16
